	...
	_: {
		...
		routes: [
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/(auth)/auth/callback/_server.ts.js'))
			},
			{
				id: "/(app)/history",
				pattern: /^\/history\/?$/,
